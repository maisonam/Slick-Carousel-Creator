...
(function(factory) {
    ...
    var svgH=$('#diamond').height(),svgW=$('#diamond').width(), svg = Snap("#diamond"),slideClone,svgtextVariables,slideNo=1,imgSrc,imgArray=["image1","image2"],imgCloneArray=["image1","image2"];
      ...
      $('#grab').on('click',function(){
       ...
       //var svgBtns = "";//<button type=\"button\" id=\"copyto\">Copy to clipboard</button>\n"+
			...
			var getOption = function(option,defaultsetting){
				...
				switch (gettype){
					case "number":
						...
						case "speed":
						case "autoplaySpeed":
						$optionsform.find("form").prepend("<fieldset><label for=\""+option+"\">"+option+"</label><input id=\""+option+"\" type=\"range\" min=\"50\" max=\"10000\" step=\"50\" value=\""+defaultsetting+"\"  /><span>"+defaultsetting+" ms</span></fieldset>");
						break;
